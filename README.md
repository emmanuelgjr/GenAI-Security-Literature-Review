...
A comprehensive, community-driven, auto-updating literature review of **GenAI and LLM security** research, standards, tools, and resources. Currently tracking **1386 resources** across **43 of 46 categories** with weekly automated updates from academic APIs.
...
```
data/
  literature.json      # Core database (1386 curated entries)
